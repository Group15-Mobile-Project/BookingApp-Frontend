...
const AdmingBookingCard = ({booking, onPress, upcoming}: {booking: BOOKING, onPress?: () => void, upcoming: boolean}) => {
    ...
    return (
        <View style={[tw('relative rounded-lg my-2 py-2 border border-gray-300 mb-4'), {borderWidth: 2}]}>
            ...
            <TouchableOpacity onPress={onPress}>
                <View style={tw('ml-4 mb-4 flex-1 w-2/3')}>
                    {upcoming ? (
...
export default AdmingBookingCard
