...
const DiscountFormCalendar = ({isVisble, setIsVisible, chosenDay, setChosenDay, openDate, closeHome, openHome}: DiscountFormCalendarProp) => {
    ...
    >
        <View style={[tw('w-full bg-white relative'), {maxHeight: windownHeigh - 100, borderTopRightRadius: 20, borderTopLeftRadius: 20}]}>
            ...
            <CalendarList
                ...
                minDate={openDate ? openDate : openHome}
                maxDate={closeHome}
                current={currentDay}
                hideExtraDays={true}
...
export default DiscountFormCalendar
