...
import MesssagesScreen from '../Tenant/MesssagesScreen';
import HostNotificationScreen from './HostNotificationScreen';
  ...
  return (
    <SafeAreaView style={tw('flex-1 bg-white')}>
        ...
        >   
            ...
            <Tab.Screen name="SearchPosts"  options={{tabBarLabel: "Notifications"}} children={() => <HostNotificationScreen></HostNotificationScreen>}/>
        </Tab.Navigator>
    </SafeAreaView >
  )
}
